    ...
    <section className="py-24 px-6 relative z-10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-zinc-400 max-w-xl mx-auto text-sm md:text-base">A simple, transparent process whether you need a fix or want to provide one.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="p-10 rounded-3xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 relative overflow-hidden"
          >
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full bg-white/10 flex items-center justify-center text-brand-primary font-bold">1</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full bg-white/10 flex items-center justify-center text-brand-primary font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-10 h-10 shrink-0 rounded-full bg-brand-primary text-black flex items-center justify-center font-bold">3</div>
                <div>
