      ...
      <div className="mx-auto max-w-5xl">
        ...
        <main className="mac-stack">
          ...
          <section className="card-vibe mac-card-pad">
            <h2 className="mb-3 text-sm font-semibold text-stone-800">Quick actions</h2>
          ...
          {/* Referral */}
          <section className="card-vibe mac-card-pad border-2 border-dashed border-violet-200/60 bg-gradient-to-br from-violet-50 to-amber-50">
            ...
            <button
              type="button"
              onClick={() => {
                const shareText = encodeURIComponent("Check out CarePay - book handymen in Enugu!");
