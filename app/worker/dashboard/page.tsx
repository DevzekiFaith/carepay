...
import { Wallet, Wrench, Star, Lightbulb, Map, Compass, MessageCircle, ChevronRight, UserCheck, X } from "lucide-react";
        ...
        <main className="space-y-8 animate-slide-up delay-1">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div className="card-vibe group relative overflow-hidden rounded-2xl p-6 transition-all hover:scale-[1.02]">
              ...
              <Wallet className="absolute -right-4 -top-4 h-24 w-24 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity select-none -rotate-12" />
            </div>
            ...
            <div className="card-vibe group relative overflow-hidden rounded-2xl p-6 transition-all hover:scale-[1.02] bg-gradient-to-br from-emerald-50/50 to-emerald-100/30 border-emerald-100">
              <div className="relative z-10">
                <p className="text-xs font-black uppercase tracking-widest text-emerald-700/60">Jobs Done</p>
                <p className="mt-2 text-4xl font-black text-emerald-700 sm:text-5xl">5</p>
              </div>
              <Wrench className="absolute -right-4 -top-4 h-24 w-24 opacity-[0.05] group-hover:opacity-[0.1] transition-opacity select-none -rotate-12" />
            </div>
            ...
            <div className="card-vibe group relative overflow-hidden rounded-2xl p-6 transition-all hover:scale-[1.02] bg-gradient-to-br from-stone-50/50 to-stone-100/30 border-stone-100">
              <div className="relative z-10">
                <p className="text-xs font-black uppercase tracking-widest text-stone-700/60">Current Rating</p>
                <div className="flex items-baseline gap-1">
                  <p className="mt-2 text-4xl font-black text-stone-900 sm:text-5xl">4.8</p>
                  <Star className="text-amber-400 fill-amber-400 h-4 w-4" />
                </div>
              </div>
              <Star className="absolute -right-4 -top-4 h-24 w-24 opacity-[0.05] group-hover:opacity-[0.1] transition-opacity select-none -rotate-12" strokeWidth={3} />
            </div>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <section className="card-vibe rounded-3xl p-6 sm:p-8 shadow-xl shadow-stone-200/40">
              <div className="mb-8 border-b border-stone-100 pb-6">
                <h2 className="text-2xl font-extrabold text-stone-900 leading-none">Upcoming Jobs</h2>
                <p className="text-xs font-bold text-stone-400 uppercase tracking-widest mt-2 px-0.5">Don't miss a beat</p>
              </div>
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`flex h-10 items-center justify-center rounded-full border-2 px-4 text-[10px] font-black uppercase tracking-widest transition-all gap-1.5 ${activeRouteJob === job.id ? "border-emerald-500 bg-emerald-500 text-white" : "border-emerald-600 bg-white text-emerald-600 hover:bg-emerald-50 shadow-md shadow-emerald-100"}`}
                        >
