    ...
    <div className="space-y-8">
      ...
      <div className="glass-panel overflow-hidden">
        ...
        <div className="px-6 py-3 bg-white/5 border-t border-white/5 flex gap-4 text-[10px] uppercase font-bold tracking-widest text-zinc-500">
          <span><strong className="text-brand-primary">{activeCitiesCount}</strong> live</span>
          <span><strong className="text-brand-primary">{upcomingCitiesCount}</strong> coming soon</span>
        </div>
      </div>
    </div>
  );
